...
export class ClusterConfigAuditReport extends Renderer.K8sApi.KubeObject {
    ...
    static apiBase = "/apis/khulnasoft-lab.github.io/v1alpha1/clusterconfigauditreports"
...
export class ConfigAuditReport extends Renderer.K8sApi.KubeObject {
    ...
    static apiBase = "/apis/khulnasoft-lab.github.io/v1alpha1/configauditreports"
