...
import {Scanner} from "../vul_operator/types";
...
export class ClusterRbacAssessmentReport extends Renderer.K8sApi.KubeObject {
    ...
    static apiBase = "/apis/khulnasoft-lab.github.io/v1alpha1/clusterrbacassessmentreports"
...
export class RbacAssessmentReport extends Renderer.K8sApi.KubeObject {
    ...
    static apiBase = "/apis/khulnasoft-lab.github.io/v1alpha1/rbacassessmentreports"
